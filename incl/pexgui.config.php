...
# Security Section:
define("SECURITY_MODULE", "no-security");                // Insert the name of one of the security modules here.
...
define("MCMYSQL_USER", 'minecraft');                // Username for database
define("MCMYSQL_PASS", '2NHE9PtFY9X7u6FF');                                // Password for database
define("MCMYSQL_DB", 'minecraft');                        // Database        name
