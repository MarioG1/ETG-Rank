...
require_once("./class/MinecraftRcon.class.php");

session_start();
$GLOBALS['wipeX_User'] = $_SESSION['name'];
...
//echo"hello";
                        ...
                        if ( $_GET['do'] == "addMem" ) {
                                ...
                                $sql = "INSERT INTO `permissions_entity` ( `name`, `type`, `prefix`, `suffix` ) VALUES ";
                        else if ( $_GET['do'] == "addPerm" )
                                $sql = "INSERT INTO `permissions` ( `name`, `type`, `permission`, `world`, `value` ) VALUES ";
                        ...
                        foreach ( $members as $member ) {
                                foreach ( $groups as $group ) {
                                        if ( ( $_GET['do'] == "addMem" ) || ( $_GET['do'] == "addParent" ) )
                                                ...
                                                $sql .= "( '".        mysql_real_escape_string( $group ) ."', '0', '". mysql_real_escape_string( $member ) ."', '', '' ) ";
                                }
                                if ( $_GET['do'] == "newGrp" )
