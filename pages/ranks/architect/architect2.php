<!-- Main hero unit for a primary marketing message or call to action -->
     ...
     <div class="span9"> <div class="hero-unit">
        <h1><font color="#AA0000">[</font><font color="#FF5555"><?php echo $config->get_architect_limits()['NAME_2'];?></font><font color="#AA0000">]</font></h1>
     </div> </div>
     <div class ="span3">
         <h4>Current <?php echo $config->get_architect_limits()['NAME_2'];?>'s:</h4>
         <?php
          $names=$server->get_playersbyrank('architect',2);
          if($names){
          foreach($names as $k)
          {
           echo '<img src="';
      ...
      <div class="row">
		...
		<div class="thumbnail">
          <h2>Description:</h2>
          <p>
              If you want to be an engineer you have to build huge redstone structures, like a tic-tac-toe game, an automated potion brewing station or an automated furnace.
          </p>
        </div>
		</div>
        <div class="span4">
