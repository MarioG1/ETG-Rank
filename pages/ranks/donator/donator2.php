<!-- Main hero unit for a primary marketing message or call to action -->
     ...
     <div class="span9"> <div class="hero-unit">
        <h1><font color="#0000AA">[</font><font color="#00AA00">V</font><font color="#FFAA00">I</font><font color="#55FFFF">P</font><font color="#0000AA">]</font></h1>
     </div> </div>
     <div class ="span3">
         <h4>Current <?php echo $config->get_donator_limits()['NAME_2'];?>'s:</h4>
         <?php
          $names=$server->get_playersbyrank('donator',2);
          if($names){
          foreach($names as $k)
          {
           echo '<img src="';
      ...
      <div class="row">
		...
		<div class="thumbnail">
          <h2>Description:</h2>
          <p>
           The VIP rank is the 2nd paid rank on this server. <br>
           You want to support our server with a donation, so that we can upgrade our server and/or the internet connection bandwidth? Then donate at least 25&euro; (=~32 US-Dollar) and enjoy the features of being a VIP.
          </p>
        </div>
		</div>
        <div class="span4">
