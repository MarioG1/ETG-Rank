...
<div class="progress progress-striped">
    <div class="bar" style="width: <?php echo calculate_proz($player->get_distance()['foot'], $config->get_voyager_limits()['WALKED_1']);?>%"></div>
</div>
<p><b>Current: <?php echo''.number_format($player->get_distance()['foot'], 0, ',', '.').' Required: '.number_format($config->get_voyager_limits()['WALKED_1'], 0, ',', '.').'</b></p>'; ?>
