...
<h4>Current rank: <?php echo $config->get_banker_limits()['NAME_1']?></h4>
<h4>Next rank: <?php echo $config->get_banker_limits()['NAME_2']?></h4>
<h5>Money</h5>
<div class="progress progress-striped">
    <div class="bar" style="width: <?php echo calculate_proz($player->get_money(), $config->get_banker_limits()['MONEY_2'])?>%"></div>
</div>
<p><b>Current: <?php echo number_format($player->get_money(), 2, ',', '.'); ?>$  Required: <?php echo number_format($config->get_banker_limits()['MONEY_2'], 2, ',', '.'); ?>$</b></p>
