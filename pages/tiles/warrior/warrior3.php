...
<p><b>Current: <?php echo calculate_kd($player->get_kills()['pvp'], $player->get_deaths()['pvp']+$player->get_deaths()['pve']); ?> Required: <?php echo $config->get_warrior_limits()['KD_3']; ?></b></p>
