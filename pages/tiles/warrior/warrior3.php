...
<h4>Current rank: <?php echo $config->get_warrior_limits()['NAME_3']?></h4>
<h4>Next rank: ---</h4>
<h5>Kills</h5>
...
<h5>K/D</h5>
<div class="progress progress-striped">
    <div class="bar" style="width: <?php echo calculate_proz(calculate_kd($player->get_kills()['pvp'], $player->get_deaths()['pvp']+$player->get_deaths()['pve']), $config->get_warrior_limits()['KD_2'])?>%"></div>
</div>
