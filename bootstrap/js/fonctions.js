$(document).ready(function(){
        ...
        function sendCommand( opNum, newCommand ) {                        //execute query
                ...
                $.get("./incl/pexgui.engine.php" + execCommand + "&queryNum=" + opNum, function(result){
        ...
        $(".finishedOps").ajaxStop(function(){
                ...
                if ( submitted ) {
                        ...
                        error = false;
                        submitted = false;
                        $.get("./incl/pexgui.engine.php?data=groups", function(result){
                          $("#column1").html(result);
                        });
                        $.get("./incl/pexgui.engine.php?data=permissions&group=" + $("#column1").val(), function(result){
                          $("#column2").html(result);
                        });
                        $.get("./incl/pexgui.engine.php?data=members&group=" + $("#column1").val(), function(result){
                          $("#column3").html(result);
                        });
                }
        });
        ...
        $(".expand").click(function(){
                ...
                if ( String($(this).attr("class")).indexOf("col2") != -1 ) {
                        ...
                        $.get("./incl/pexgui.engine.php?data=permissions&inherited=true&group=" + $("#column1").val(), function(result){
        ...
        $("div.logLoader").click(function(){
                $.get("./incl/pexgui.engine.php?data=getlogs&start=" + logLim , function(result){
                        var append = "";
                        if ( logLim != 0 )
  ...
  $("#column1").change(function(){
        ...
        $.get("./incl/pexgui.engine.php?data=permissions&group=" + $(this).val(), function(result){
          $("#column2").html(result);
          //$("#pHead").html("");
        });
        $.get("./incl/pexgui.engine.php?data=members&group=" + $(this).val(), function(result){
          $("#column3").html(result);
          //$("#mHead").html("");
        });
